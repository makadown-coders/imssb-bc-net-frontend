...
import { PeriodoFechasService } from '../periodo-fechas/periodo-fechas.service';
import { ClaveGrupo, CPMS, hospitalesData, Inventario, InventarioFull, InventarioRow, UnidadExistente } from '../../models';
...
/**
 * @author Mario Serrano (github @mserrano-imssb)
 */
@Injectable({
  providedIn: 'root'
})
