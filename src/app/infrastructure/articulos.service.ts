...
export class ArticulosService {
  ...
  /**
   * @deprecated Ya no existe articulos.json en /public, ahora se jalaria por postgres
   * @param termino
   * @returns
   */
  ...
  /**
  * @deprecated Ya no existe articulos-primernivel.json en /public, ahora se jalaria por postgres
  */
